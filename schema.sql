...
CREATE TABLE IF NOT EXISTS flight_booking (
    ...
    FOREIGN KEY (booking_date) REFERENCES calendar(date_id)
...
CREATE TABLE IF NOT EXISTS calendar (
    cal_date varchar(4) NOT NULL,
    date_year varchar(30) NOT NULL,
    date_month varchar(30) NOT NULL,
    date_day varchar(30) NOT NULL,
